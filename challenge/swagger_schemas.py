...
add_existing_challenge_audio_schema = openapi.Schema(
    type=openapi.TYPE_OBJECT,
    properties={
        'challenge_id': openapi.Schema(type=openapi.TYPE_INTEGER, description="ID of the competition to which the audio will be added."),
...
add_existing_challenge_audio_response_schema = openapi.Schema(
    type=openapi.TYPE_OBJECT,
    properties={
